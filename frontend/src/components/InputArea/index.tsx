    ...
    <div className="px-4 py-3 border-t border-gray-200/50 bg-white/50 backdrop-blur-sm">
      <div className="flex items-end gap-2 max-w-3xl mx-auto">
        <textarea
          ...
          rows={1}
          className="flex-1 resize-none rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#667eea]/30 focus:border-[#667eea] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        />
        <button
          onClick={handleSend}
